...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } elseif ($capaciteMax < (int) $event['places_reservees']) {
...
<section class="mx-auto max-w-3xl px-4 py-12 md:px-8">
    <div class="mb-8">
        ...
        <p class="mt-2 text-slate-600">Mettez à jour les informations de votre événement.</p>
    </div>
        ...
        <form method="post" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid gap-5 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="number" min="<?= e((string) max(1, (int) $event['places_reservees'])) ?>" id="capacite_max" name="capacite_max" value="<?= e(old('capacite_max', (string) $event['capacite_max'])) ?>" class="w-full rounded-lg border border-slate-300 px-3 py-2" required>
                </div>
            </div>
            ...
            <div class="rounded-2xl bg-slate-50 p-5">
                ...
                <label for="image" class="mb-2 mt-5 block text-sm font-semibold text-slate-700">Remplacer l'image (optionnel)</label>
